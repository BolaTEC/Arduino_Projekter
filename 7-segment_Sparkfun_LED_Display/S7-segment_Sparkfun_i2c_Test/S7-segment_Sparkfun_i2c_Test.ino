...
void setup()
{
  ...
  setBrightnessI2C(0);  // Lowest brightness          7mA 
  delay(1500);
  //setBrightnessI2C(64);  // Medium Low brightness   9mA  
  //setBrightnessI2C(128);  // Medium brightness      11mA
  //setBrightnessI2C(192);  // Medium High brightness 13mA
  setBrightnessI2C(255);  // High brightness        15mA
  delay(1500);
...
void loop()
{
  ...
  if (counter < 10000)
    setDecimalsI2C(0b00000100);  // Sets digit 3 decimal on eg. 999.4
  else
    setDecimalsI2C(0b00001000);  // Sets digit 3 decimal on  1000.

  //setDecimalsI2C(0b00000001);  // Sets digit 1 decimal on  1.000
  //setDecimalsI2C(0b00000010);  // Sets digit 2 decimal on  10.00
  //setDecimalsI2C(0b00000100);  // Sets digit 3 decimal on  100.0
  //setDecimalsI2C(0b00001000);  // Sets digit 4 decimal on  1000.
  //setDecimalsI2C(0b00010000);  // Sets clock colon on  10:00
  //setDecimalsI2C(0b00100000);  // Sets apostrof on  100'0
  
  counter++;  // Increment the counter
  delay(200);  // This will make the display update at 10Hz.*/
}
